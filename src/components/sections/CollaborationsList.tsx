      ...
      <ul>
        {brands.map((b) => (
          <li key={b.slug} className="border-b border-cognac/20 first:border-t">
            ...
            >
              <span className="font-display text-2xl font-light leading-none tracking-[-0.01em] text-onyx transition-colors duration-300 group-hover:text-forest md:text-[40px]">
                {b.name}
              </span>
